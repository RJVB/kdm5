...
class KFontRequester : public QWidget
{
    ...
    Q_PROPERTY(bool alwaysTriggerSignal READ alwaysTriggerSignal WRITE setAlwaysTriggerSignal)
...
public:
    ...
    /**
     * will the widget always send the fontSelected signal or not
     * 
     * When set (the default), the fontSelected signal will also be sent
     * when the font has been set programmatically, via setFont().
     */
    virtual bool alwaysTriggerSignal();
    /**
     * will the widget always send the fontSelected signal or not
     */
    virtual void setAlwaysTriggerSignal(bool enable);
